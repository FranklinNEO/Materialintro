...
public class MaterialIntroView extends RelativeLayout {
    ...
    private boolean isInfoImageViewEnabled;
    ...
    private void init(Context context) {
        ...
        layout_background = android.R.color.transparent;
        ...
        card_view = (CardView) layoutInfo.findViewById(R.id.card_view);
        info_iv = (ImageView) layoutInfo.findViewById(R.id.info_iv);
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (circleShape != null && circleShape.getPoint().y != 0 && !isLayoutCompleted) {
                    ...
                    if (isDotViewEnabled)
                        setDotViewLayout();
                    if (isInfoImageViewEnabled)
                        setInfoImageViewLayout();
    ...
    private void setInfoImageViewLayout() {
        handler.post(new Runnable() {
            @Override
            public void run() {
                isLayoutCompleted = true;
                ...
                infoView.setLayoutParams(infoDialogParams);
                infoView.postInvalidate();
                info_iv.setBackgroundResource(layout_background);
                addView(infoView);
    ...
    public void setLayout_background(int layout_background) {
    ...
    private void enableInfoImageView(boolean isInfoImageViewEnabled) {
        this.isInfoImageViewEnabled = isInfoImageViewEnabled;
    }
    ...
    public static class Builder {
        ...
        public Builder setLayout_background(int layout_background) {
            materialIntroView.enableInfoImageView(true);
            materialIntroView.setLayout_background(layout_background);
            return this;
        }
